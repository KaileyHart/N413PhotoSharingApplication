                ...
                <div class="index">
                    ...
                    if ($results === 0) {
                        ...
                        foreach ($results as $result) {
                            ...
                            <div class='index_images--info-user'><img style='margin-right: 10px;' class='user_img' alt='User profile image' src='dist/images/" . $result["user_img"] ."' / >
                            <p>" . $result['username'] . "</p></div>   <div class='index_images--info-tag'> <p class='index_images--tag'> " . $result['tag_name'] . " </p> <p style='padding-left: 10px;'>" . $result['gallery_name'] . "</p></div></div>
