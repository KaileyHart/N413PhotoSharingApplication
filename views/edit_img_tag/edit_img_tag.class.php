...
?>
<div  style="margin-left: 32%; display: flex; align-items: center; margin-bottom: 30px;">
            <a href="index.php?action=single_gallery_view&id=<?= $_GET['id'] ?>" style="color: #000; margin-top: 50px;">
