 ...
 * Author: Kailey Hart
 * Date: 03-16-2021
 * Name: edit_profile_image_confirm.php
 * Description: Edit Profile Image Confirmation
*/

class EditProfileImageConfirm extends MainView
{
...
<div style="max-width: 900px; display: flex;flex-direction: column;   margin: 0 auto; text-align: center;">
    <h2 style="margin-bottom: 30px; margin-top: 30px; ">You successfully edited your profile image!</h2>
