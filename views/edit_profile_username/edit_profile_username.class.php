...
?>
        <form method="POST" action="index.php?action=edit_profile_username_confirm&id=<?= $username['pk_user_id'] ?>" enctype="multipart/form-data" class="profile__container">
            <div class="edit_left">
                <div style="display: flex; align-items: center; margin-bottom: 30px;">
                    <a href="index.php?action=edit_profile" style="margin-right: 2%; color: black">
                    ...
                    <h3>Edit Your User Name: </h3>
                </div>


                <div id="form-container">
                    <input type="text" id="username" name="username" class="form-control" value="" placeholder="Enter User New Username" required />
